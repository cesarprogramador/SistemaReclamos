...
(33,30,5,'NO','de 1 a 2','I','2017-11-07 06:39:09'),
(34,30,12,'SI','de 2 a 3','I','2017-11-07 06:39:26'),
(35,30,6,'SI','de 3 a 4','I','2017-11-07 06:39:40'),
(36,30,7,'NO','de 4 a 5','I','2017-11-07 06:40:00');
...
(7,'APE','NOMBRE','1','3','2','EMAIL','CALLE',4,'PISO','DPTO',3,'REFER','OBS','M','2017-11-03 02:20:07',1,'1','','2017-11-03',NULL),
(8,'APE MODIFICADO','NOMBRE 12','12','12','12','EMAIL 12','CALLE 12',12,'PISO','DPTO',1,'','OBS MODIFICADO A1','M','2017-11-03 03:41:33',1,'1','','2017-11-03',NULL),
...
(14,'APE ADMIN','NOMBRE ADMIN','1','1','1','EMAIL ADM','CALLE ADM',1,'1','1',1,'','OBS ADM','M','2017-11-03 03:47:29',3,'1','','2017-11-03',NULL),
(15,'APE ADMIN','NOMBRE ADMIN','1','1','1','EMAIL ADM','CALLE ADM',1,'1','1',1,'','OBS ADM','N','2017-11-03 03:34:18',3,'1','','2017-11-03',NULL),
(16,'APE ADMIN','NOMBRE ADMIN','1','1','1','EMAIL ADM','CALLE ADM',1,'1','1',1,'','OBS ADM','N','2017-11-03 03:34:18',3,'1','','2017-11-03',NULL),
...
insert  into `reclamos`(`idreclamo`,`fechainicio`,`fechafin`,`idcliente`,`idempleado`,`idtiporeclamo`,`numeroreferencia`,`accion`,`fechaaccion`) values 
(30,'2017-11-07 06:39:09',NULL,1,1,2,'R063856','I','2017-11-07 06:39:09');
...
BEGIN
	PREPARE STMT FROM " SELECT a.idreclamo,c.tiporeclamo,a.fechainicio,a.fechafin,b.idhistorialreclamo,b.idproblematicareclamo,d.problematicareclamo,b.respuesta,b.observacion,c.idtiporeclamo
...
when 'N' then
	...
	VALUE (_apellido,_nombre,_dni,_cel,_tel,_email,_calle,_numero,_piso,_dpto,_idtiposervicio,_numreferencia,_observacion,_idtipopersona,_accion,_fechaaccion,_dni,'',_fechaaccion);
when 'M' then		
	update personas set apellido=_apellido,nombre=_nombre,dni=_dni,cel=_cel,tel=_tel,email=_email,calle=_calle,numero=_numero,piso=_piso,dpto=_dpto,idtiposervicio=_idtiposervicio,numreferencia=_numreferencia,observacion=_observacion,accion=_accion,fechaaccion=_fechaaccion,idtipopersona=_idtipopersona
...
when 'M' then		
	update reclamos set fechainicio=_fechaini,idcliente=_idcliente,idempleado=_idempleado,accion=_accion,fechaaccion=_fechaaccion
...
ELSE			
	PREPARE STMT FROM "SELECT a.apellido,a.nombre,a.dni,a.cel,a.tel,a.email,a.calle,a.numero,a.piso,a.dpto,b.tipopersona,a.observacion,a.fechaingreso,a.fechaegreso
